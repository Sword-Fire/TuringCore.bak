package net.geekmc.turingcore.command.kommand
...
fun Kommand.format(
    ...
    vararg arguments: Argument<*> = arrayOf(),
    executor: Kommand.SyntaxContext.() -> Unit
) = this@format.format(lim1, lim2, FormatLimits.NONE, FormatLimits.NONE, FormatLimits.NONE, *arguments, executor = executor)
